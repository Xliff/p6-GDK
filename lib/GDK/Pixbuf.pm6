...
class GDK::Pixbuf {
  ...
  method composite(*@a) {
    GDK::Pixbuf::Transforms.composite($!p, |@a);
  }

  method composite_color(*@a) is also<composite-color> {
    GDK::Pixbuf::Transforms.composite_color($!p, |@a);
  }

  method composite_color_simple(*@a) is also<compsite-color-simple> {
    GDK::Pixbuf::Transforms.composite_color_simple($!p, |@a);
  }

  method flip (*@a) {
    GDK::Pixbuf::Transforms.flip($!p, |@a);
  }

  method scale (*@a) {
    GDK::Pixbuf::Transforms.scale($!p, |@a);
  }

  method scale_simple(*@a) is also<scale-simple> {
    GDK::Pixbuf::Transforms.scale_simple($!p, |@a);
  }
