...
# Function definition finished, but detected no match:
# ' gboolean gdk_pixbuf_save_to_buffer      (GdkPixbuf  *pixbuf,                                   Str     **buffer,                                     gsize      *buffer_size,                                       const char *type,                                       CArray[Pointer[GError]]    **error,                            ...) G_GNUC_NULL_TERMINATED;'
# Function definition finished, but detected no match:
...
# Function definition finished, but detected no match:
# ' void gdk_pixbuf_save_to_stream_async (GdkPixbuf           *pixbuf,                                  GOutputStream       *stream,                                  const Str         *type,                                       GCancellable        *cancellable,                                       GAsyncReadyCallback  callback,                                 gpointer             user_data,                                 ...);'
...
sub gdk_pixbuf_get_option (GdkPixbuf $pixbuf, Str $key)
  returns Str
  is      native(gdk-pixbuf)
  is      export
{ * }
...
sub gdk_pixbuf_remove_option (GdkPixbuf $pixbuf, Str $key)
  returns uint32
  is      native(gdk-pixbuf)
  is      export
{ * }
...
sub gdk_pixbuf_set_option (GdkPixbuf $pixbuf, Str $key, Str $value)
  returns uint32
  is      native(gdk-pixbuf)
  is      export
{ * }
