...
class GDK::Device {
    ...
    is also<get-associated-device>
  {
    ...
    $device ?? GDK::Device.new($device) !! Nil;
  }
  ...
  method mode is rw {
    Proxy.new(
      FETCH => sub ($) {
        GdkInputModeEnum( gdk_device_get_mode($!d) );
      },
  ...
  method device-manager is rw is also<device_manager> {
    ...
    Proxy.new(
      ...
      STORE => -> $, GdkDeviceManager() $val is copy {
        say 'device-manager can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method display (:$raw = False) is rw {
    ...
    Proxy.new(
      ...
      STORE => -> $, $val is copy {
        say 'display can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method has-cursor is rw is also<has_cursor> {
    ...
    Proxy.new(
      ...
      STORE => -> $, $val is copy {
        say 'has-cursor can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method input-mode is rw is also<input_mode> {
    ...
    Proxy.new(
      FETCH => -> $ {
        ...
        GdkInputModeEnum( $gv.uint );
      },
      STORE => -> $, Int() $val is copy {
        say 'input-mode can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method input-source is rw is also<input_source> {
    ...
    Proxy.new(
      ...
      STORE => -> $, Int() $val is copy {
        say 'input-source can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method name is rw {
    ...
    Proxy.new(
      ...
      STORE => -> $, $val is copy {
        say 'name can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method num-touches is rw is also<num_touches> {
    ...
    Proxy.new(
      ...
      STORE => -> $, $val is copy {
        say 'num-touches can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method product-id is rw is also<product_id> {
    ...
    Proxy.new(
      ...
      STORE => -> $, $val is copy {
        say 'product-id can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method type is rw {
    ...
    Proxy.new(
      FETCH => -> $ {
        ...
        GdkDeviceTypeEnum( $gv.uint );
      },
      STORE => -> $, $val is copy {
        say 'type can only be set at construct time' if $DEBUG;
      }
    );
  }
  ...
  method vendor-id is rw is also<vendor_id> {
    ...
    Proxy.new(
      ...
      STORE => -> $, $val is copy {
        say 'vendor-id can only be set at construct time' if $DEBUG;
      }
    );
  }
  # ↑↑↑↑ PROPERTIES ↑↑↑↑
  ...
  # ↓↓↓↓ METHODS ↓↓↓↓
  method free_history (Int() $n_events) is also<free-history> {
    my gint $ne = $n_events;
  ...
  method get_axis_use (Int() $index) is also<get-axis-use> {
    ...
    GdkAxisUseEnum( gdk_device_get_axis_use($!d, $i) );
  }
  ...
  method get_device_type is also<get-device-type> {
    GdkDeviceTypeEnum( gdk_device_get_device_type($!d) );
  }

  method get_display (:$raw = False) is also<get-display> {
    my $d = gdk_device_get_display($!d);
  ...
  method get_history (
    ...
    is also<get-history>
  {
    my guint ($st, $sp, $e) = ($start, $stop, $events);
    my $ne = $n_events;
  ...
  method get_last_event_window (:$raw = False)
    is also<get-last-event-window>
  {
    my $w = gdk_device_get_last_event_window($!d);
  ...
  method get_source is also<get-source> {
    GdkInputSourceEnum( gdk_device_get_source($!d) );
  }
  ...
  method grab (
    ...
    my gboolean $oe = $owner_events.so.Int;
    my guint ($go, $em, $t) = ($grab_ownership, $event_mask, $time);
  ...
  method list_axes (:$glist = False) is also<list-axes> {
    my $al = gdk_device_list_axes($!d);

    return Nil unless $al;
    return $al if $glist;

    GLib::GList.new($al).Array;
  }

  method list_slave_devices (:$glist = False, :$raw = False)
    is also<list-slave-devices>
  {
    my $dl = gdk_device_list_slave_devices($!d);

    return Nil unless $dl;
    return $dl if $glist;

    $dl = GLib::GList.new($dl) but GLib::Roles::ListData[GdkDevice];
    $raw ?? $dl.Array !! $dl.Array.map({ GDK::Device.new($_) });
  }

  method set_axis_use (Int() $index, Int() $use)
    is also<set-axis-use>
  {
    my guint ($i, $u) = ($index, $use);
